...
In this file, the speed, vision, and separation values that control how the
agents perceive and react to eachoer are varied.
"""
...
model_data = run_model(float(sys.argv[1]), float(sys.argv[2]), float(sys.argv[1]))
