...
For this version of the model, the agents have a blind spot behind them. The
extent of this spot can be manipulated in the model parameters.
...
class ShoalModel(Model):
    ...
    # Todo: add slider for blind spot to viz file
