...
# separation) i times
for i in range(3):
    file.write("python3 ../../ichec_run_speed.py > ../output/26feb2020/speed_output"
               + str(i) + ".txt \n")

for i in range(3):
    file.write("python3 ../../ichec_run_vision.py > ../output/26feb2020/vision_output"
               + str(i) + ".txt \n")

for i in range(3):
    file.write("python3 ../../ichec_run_sep.py > ../output/26feb2020/sep_output"
               + str(i) + ".txt \n")
