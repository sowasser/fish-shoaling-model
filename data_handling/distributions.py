...
speed_dist = gamma.rvs(size=10000, a=2, loc=0, scale=0.5)
vision_dist = gamma.rvs(size=10000, a=10, loc=0, scale=0.5)
sep_dist = gamma.rvs(size=10000, a=2, loc=0, scale=0.5)
