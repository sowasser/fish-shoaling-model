...
def polar(model):  # WORKS
    ...
    For this instance of the model, the polarization function is especially
    important because the boids have been given no instructions to align with
    each other (match velocities).
    """
...
server = ModularServer(ShoalModel, [shoal_canvas, polar_chart, neighbor_chart],
                       "Shoaling Behaviour Model - No Alignment Parameter",
