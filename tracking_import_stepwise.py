...
centroid_distance = [centroid_dist(s1), centroid_dist(s2), centroid_dist(s3),
                     ...
                     centroid_dist(s13), centroid_dist(s14), centroid_dist(s15),
                     centroid_dist(s16), centroid_dist(s17), centroid_dist(s18),
                     centroid_dist(s19), centroid_dist(s20), centroid_dist(s21)]
...
nn_distance = [nnd(s1), nnd(s2), nnd(s3), nnd(s4), nnd(s5), nnd(s6), nnd(s7),
               ...
               nnd(s14), nnd(s15), nnd(s16), nnd(s17), nnd(s18), nnd(s19),
               nnd(s20), nnd(s21)]
...
shoal_area = [area(s1), area(s2), area(s3), area(s4), area(s5), area(s6),
              ...
              area(s13), area(s14), area(s15), area(s16), area(s17), area(s18),
              area(s19), area(s20), area(s21)]
